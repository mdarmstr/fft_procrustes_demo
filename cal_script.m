function cal_script(matrix1,matrix2,shift)
...
subplot(2,2,1);
imagesc(matrix1);
title(sprintf('Cal1: fNorm=%.4e', norm(matrix1, 'fro')), 'FontSize', 12);
...
subplot(2,2,2);
imagesc(matrix2);
title(sprintf('Cal2: fNorm=%.4e', norm(matrix2, 'fro')), 'FontSize', 12);
xlabel('Relative ^1t_R', 'FontSize', 12);
ylabel('Relative ^2t_R', 'FontSize', 12);
set(gca, 'YDir', 'normal');
...
subplot(2,2,3);
imagesc(imgAlign);
title(sprintf('Cal1 Aligned: fNorm=%.4e', norm(imgAlign, 'fro')), 'FontSize', 12);
xlabel('Relative ^1t_R', 'FontSize', 12);
ylabel('Relative ^2t_R', 'FontSize', 12);
set(gca, 'YDir', 'normal');

% Export figure
exportgraphics(gcf, 'cal_analysis.pdf', 'Resolution', 500);
